...

    {
        ...
        public void OnFoot()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                setToWalk.Click();
                DemoHelper.Pause();
                driver.FindElement(By.XPath("/html/body/div[3]/div[9]/div[3]/div[1]/div[2]/div/div[3]/div[1]/div[1]/div[2]/div[1]/div/input")).SendKeys("Plac Defilad 1");
                DemoHelper.Pause();
                driver.FindElement(By.XPath("/html/body/div[3]/div[9]/div[3]/div[1]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div[1]/div/input")).SendKeys("Chłodna 51");
                DemoHelper.Pause();
